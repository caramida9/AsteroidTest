...
{
	for (ColliderList::const_iterator colliderAIt = colliders_.begin() , end = colliders_.end(); colliderAIt != colliders_.end(); ++colliderAIt)
	{
		for (ColliderList::const_iterator colliderBIt = colliderAIt; colliderBIt != end; ++colliderBIt)
		{
			if (colliderBIt != colliderAIt)
			{
